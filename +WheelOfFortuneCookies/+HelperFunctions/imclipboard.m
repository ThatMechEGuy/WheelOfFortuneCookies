...
switch clipmode
    ...
    case 'paste'
        ...
        try
            ...
            % From Nate: I didn't like that this message was always appearing in the command window
            % when I was already handling the error. The easiest way to prevent the message was to
            % disable this. The best way to do this would be to add a flag to this function to
            % enable/disable writing messages to the command window, but I don't have time for that
            % right now.
